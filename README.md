# [Kanban Board Application](https://quicksell-front-end-assignment-kanban.vercel.app/)
...
You can see a live demo of the Kanban board application [here](https://quicksell-front-end-assignment-kanban.vercel.app/).
...
1. Clone the repository:
   ```bash
   git clone https://github.com/Kamleshwarpradhan/QuicksellFrontEndAssignmentKanban.git
   ```

2. Navigate to the project directory:
    ```bash
    cd QuicksellFrontEndAssignmentKanban
    ```
...
- **Name:** Kamleshwar Pradhan
- **Email:** [kamleshwarpradhan1208@gmail.com](mailto:kamleshwarpradhan1208@gmail.com)
